...
//                System.out.println("Unknown/null message received");
                ...
                assignedTutorialSlots.forEach((currentTimeslotId, isLocked) -> {
                    ...
                    if (unwantedTutorialsOnOfferFiltered.size() > 0) {
                        ...
                        if (bestSwapId != null) {
                            ...
                            offerSwap.setOfferingStudent(this.myAgent.getAID());
    ...
    //GETTING RID OF OWN SLOTS//
    //receive proposals for slot swaps
                    ...
                    if (contentElement instanceof Action) {
                        ...
                        if (action instanceof OfferSwap) {
                            ...
                            if (utilityChange >= minimumSwapUtilityGain) {
                                ...
                                System.out.println(student.getMatriculationNumber() + " rejected proposal to swap slot for " + offeredTutorialSlot);
                                ...
                                if (confirm != null && confirm.getConversationId().equals("propose-timeslot-swap")) {
                                    System.out.println("timetabler confirmed " + student.getMatriculationNumber() + "'s proposal rejection for " + offeredTutorialSlot);
